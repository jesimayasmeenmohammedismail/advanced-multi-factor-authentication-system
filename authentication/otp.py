...
class otp:
    ...
    def start(self):
        ...
        self.login_frame = PhotoImage(file='../../Fingerprint_Recognition_and_Otp_Verification_system_using_python-master/otp_verification_frame.png')
        ...
        self.verify = PhotoImage(file='../../Fingerprint_Recognition_and_Otp_Verification_system_using_python-master/verify.png')
        ...
        self.send_otp = PhotoImage(file='../../Fingerprint_Recognition_and_Otp_Verification_system_using_python-master/send_otp.png')
        ...
        self.exit_img = PhotoImage(file='../../Fingerprint_Recognition_and_Otp_Verification_system_using_python-master/exit.png')
            ...
            try:
                try:
                    ...
                    if "@" in self.email_entry.get():
                        ...
                        server.login("basilshinoy@gmail.com", "panavelilbasilpc")
                        self.e = str(self.email_entry.get())
                        server.sendmail("basilshinoy@gmail.com", f"{self.e}", f"{self.value}")
                        ...
                        client.messages.create(to=(age1), from_="+17622494815", body=self.value)
